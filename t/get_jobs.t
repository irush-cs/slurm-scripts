...
my %jobs = (1 => {"JobId" => "1",
                  ...
                  "CoreSpec" => "*",
                  "_DETAILS" => [{"Nodes" => "node-63", "CPU_IDs" => "22-23", "Mem" => "1000", "GRES_IDX" => "", "_GRES" => {}, "_JobId" => 1, "_nCPUs" => 2, "_EndTime" => "2019-02-01T10:35:54", "_NodeList" => ['node-63']},
                                 {"Nodes" => "node-64", "CPU_IDs" => "4-7",   "Mem" => "2000", "GRES_IDX" => "", "_GRES" => {}, "_JobId" => 1, "_nCPUs" => 4, "_EndTime" => "2019-02-01T10:35:54", "_NodeList" => ['node-64']},
                                 {"Nodes" => "node-65", "CPU_IDs" => "20-21", "Mem" => "1000", "GRES_IDX" => "", "_GRES" => {}, "_JobId" => 1, "_nCPUs" => 2, "_EndTime" => "2019-02-01T10:35:54", "_NodeList" => ['node-65']},
                                ],
                  "MinCPUsNode" => "1",
                  "MinMemoryCPU" => "500M",
                  "MinTmpDiskNode" => "0",
            ...
            2398617 => {
                        ...
                        "NtasksPerN:B:S:C" => "0:0:*:*",
                        "CoreSpec" => "*",
                        "_DETAILS" => [{"Nodes" => "node-44", "CPU_IDs" => "2-3", "Mem" => "16000", "GRES_IDX" => "", "_JobId" => "2398617", "_NodeList" => ["node-44"], "_EndTime" => "2019-01-31T16:19:20", "_GRES" => {}, "_nCPUs" => 2, "_NodeList" => ["node-44"]}],
                        "MinCPUsNode" => "1",
                        "MinMemoryCPU" => "8000M",
                        "MinTmpDiskNode" => "0",
                        "Features" => "(null)",
            ...
            153291 => {
                       ...
                       "NtasksPerN:B:S:C" => "0:0:*:*",
                       "CoreSpec" => "*",
                       "_DETAILS" => [{"Nodes" => "node-06", "CPU_IDs" => "10-11,15,21", "Mem" => "81920", "GRES_IDX" => "gpu(IDX:0,2-3,5)", "_JobId" => 153291, "_GRES" => {gpu => 4}, "_EndTime" => "2019-02-14T16:05:09", "_nCPUs" => 4, "_NodeList" => ["node-06"]}],
                       "MinCPUsNode" => "4",
                       "MinMemoryNode" => "80G",
                       "MinTmpDiskNode" => "0",
                       "Features" => "(null)",
